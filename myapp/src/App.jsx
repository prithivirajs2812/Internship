...
import Routetype from "./assets/components/Routetype";
import NestedRoute from "./assets/components/NestedRoute";
import ChildRoute from "./assets/components/ChildRoute";
import UseMemo from "./assets/components/UseMemo";
import CustomHook from "./assets/components/CustomHook";
  ...
  return (
    <div className="app">
      <nav className="nav-links">
        <ul>
          <li>
            <Link to="/componentEx">Component Example</Link>
          </li>
          <li>
            <Link to="/jsxEx">JSX Example</Link>
          </li>
          <li>
            <Link to="/propsEx">Props Example</Link>
          </li>
          <li>
            <Link to="/stateEx">State Example</Link>
          </li>
          <li>
            <Link to="/eventEx">Event Handling Example</Link>
          </li>
          <li>
            <Link to="/conditionEx">Conditional Rendering Example</Link>
          </li>
          <li>
            <Link to="/listEx">List Rendering Example</Link>
          </li>
          <li>
            <Link to="/formEx">Form Example</Link>
          </li>
          <li>
            <Link to="/useEffectEx">UseEffect Example</Link>
          </li>
          <li>
            <Link to="/useRefEx">UseRef Example</Link>
          </li>
          <li>
            <Link to="/contextEx">UseContext Example</Link>
          </li>
          <li>
            <Link to="/fetchEx">Fetch Data Example</Link>
          </li>
          <li>
            <Link to="/routetypes">Route Types Example</Link>
          </li>
          <li>
            <Link to="/useMemoEx">useMemo Examples</Link>
          </li>
          <li>
            <Link to="/customHookEx">Custom hook Example</Link>
          </li>
        </ul>
      </nav>
      ...
      <Routes>
        ...
        {/* useMemo */}
        <Route path="/useMemoEx" element={<UseMemo />} />

        {/* custom hook Example */}
        <Route path="/customHookEx" element={<CustomHook />} />
      </Routes>
    </div>
  );
};
